...
This project currently supports local actorized raytracing, clustered actorized raytracing across a local network, multiple serializers, as well as photometric rendering locally and across a network.
...
There are several different config files that can be loaded in to support standard Java serialization, Jackson, and Kryo serializers.
