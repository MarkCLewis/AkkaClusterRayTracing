...
object ImageDrawer {
  case class Start(eye: Point, topLeft: Point, right: Vect, down: Vect) extends KryoSerializable
  case class SetColor(i: Int, j: Int, color: RTColor) extends KryoSerializable
}